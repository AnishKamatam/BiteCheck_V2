...
def load_data_and_split():
    # Loads embedded dataset and splits into train/test sets
    ...
    # Count feature types for logging
...
def train_smote_model(X_train, y_train):
    # Trains XGBoost model using SMOTE oversampling
...
def train_adasyn_model(X_train, y_train):
    # Trains XGBoost model using ADASYN oversampling
...
def evaluate_ensemble(model_smote, model_adasyn, X_test, y_test):
    # Evaluates ensemble performance using max probability strategy
...
def train_final_model():
    # Trains both SMOTE and ADASYN models, then evaluates ensemble performance
